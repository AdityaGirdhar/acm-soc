            ...
            <div className={'w-full flex justify-center sm:w-4/5'}>
                <div className = {"w-4/5 sm:max-w-screen"}>
                    ...
                    <div className = {'flex justify-center sm:text-[18px] text-[12px] sm:pb-2 py-2 text-center'}>
                        ...
                        <a href="https://codeforces.com/contestInvitation/a31dd4d62f2f09cf1fe904bdcbd92f763f6d8c74" className = {'w-1/2 cursor-default sm:px-[100px] py-2 bg-gradient-to-r from-[#ffffff18] to-[#ffffff08] rounded-xl mt-5 backdrop-blur-sm' } >
                            Day 1-Programming
                        </a>
