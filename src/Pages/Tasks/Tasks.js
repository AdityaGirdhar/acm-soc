        ...
        <div className = {'min-w-screen min-h-screen flex sm:py-10 pt-5 justify-center items-center'}>
            ...
            <div className={'w-full flex justify-center sm:w-4/5'}>
                <div className = {"w-4/5 sm:max-w-screen"}>
                    ...
                    <div className = {'flex justify-center sm:text-[18px] text-[12px] sm:pb-2 py-2'}>
                    <Link to={'/day7'} className = {'w-1/2 text-center cursor-pointer sm:px-[100px] py-2 bg-gradient-to-r from-[#ffffff18] to-[#ffffff08] rounded-xl mt-5 backdrop-blur-sm' } >
                        {"Day 7-Generative AI"}</Link>
                    </div>
                    <div className = {'flex justify-center sm:text-[18px] text-[12px] sm:pb-2 py-2'}>
                    <Link to={'/dayT'} className = {'w-1/2 text-center cursor-pointer sm:px-[100px] py-2 bg-gradient-to-r from-[#ffffff18] to-[#ffffff08] rounded-xl mt-5 backdrop-blur-sm' } >
                        {"Day 8-10 - IDEATHON"}</Link>
                    </div>                    
                </div>
            </div>
